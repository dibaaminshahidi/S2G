...
from src.config.hyperparameters.best_parameters import ns_gnn_4, dynamic, lstmgnn
...
#            if hyperparameters['g_version'] == '2d':
#                best_params = ns_gnn_2d[hyperparameters['task']][hyperparameters['gnn_name']]
            if '4' in config['g_version']:
